export default [
  {
    No: "1.1",
    Lingkup:
      "Analisis Kondisi Eksternal (APT, Fakultas, Pascasarjana, Vokasi, Prodi di bawah Rektor)",
    Auditee: "Dekan, Direktur, Koordinator Prodi di bawah Rektor",
    Dokumen: [
      {
        Name: "SK Penanggung Jawab/SK Tupoksi Penanggung jawab",
      },
      {
        Name: "Bukti Implementasi kebijakan evaluasi kondisi eksternal",
      },
      {
        Name: "SOP",
      },
      {
        Name: "TOR Pelaksanaan/Proposal",
      },
      {
        Name: "SK atau Surat Tugas tim pelaksana",
      },
      {
        Name: "Name bukti kinerja tim pelaksana",
      },
      {
    ...
    Catatan: [
      "Minimal 1 kali dalam 4 tahun sesuai periode Renstra",
      "Dokumen bukti setiap tahun dijadikan 1 berkas",
    ],
  },
  {
    No: "1.2",
    Lingkup: "Tindak Lanjut Analisis Kondisi Eksternal",
    Auditee: "Dekan, Direktur, Koordinator Prodi di bawah Rektor",
    Dokumen: [
      {
        Name:
  ...
  },
  {
    ...
    Dokumen: [
      ...
      {
        Name: "SK Ijin Operasional (awal dan perpanjangan)",
      },
      {
  ...
  {
    No: "3",
    Lingkup: "Visi, Misi, Tujuan, Strategi, dan Tata Nilai",
    Auditee:
      "Dekan, Direktur, Koordinator Prodi di bawah Rektor, Ketua Prodi di bawah Rektor",
    Dokumen: [
      {
  ...
  {
    No: "4",
    Lingkup: "Sosialisasi VMTS dan tata nilai",
    Auditee:
      "Dekan, Direktur, Koordinator Prodi di bawah Rektor, Ketua Prodi di bawah Rektor",
    Dokumen: [
      {
  ...
  },
  {
    ...
    Dokumen: [
      ...
      {
        Name: "SOP Evaluasi pencapaian indikator VMTS dan tata nilai",
      },
      {
